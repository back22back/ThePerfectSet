...
const fetchBusinesses = (location, categories) => {
	...
	return axios.get('https://api.yelp.com/v3/businesses/search', params).then((data) => {
		const businessData = [];
...
const fetchSpecificBusiness = (business_id) => {
	...
	return axios.get(`https://api.yelp.com/v3/businesses/${business_id}`, params).then((data) => {
